...
test_that("Zbeta calcualtes Zbeta statistic correctly with character matrix", {
...
test_that("Zbeta fails with an X supplied outside of the region defined in pos", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = c(7000,9000)),
...
test_that("Zbeta fails with an X supplied as a character", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = c("700bp","900bp")),
...
test_that("Zbeta fails with an X supplied as only one number", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = 700),
               "X should be a numeric vector of length 2 e.g. c(100,200)",
               fixed=TRUE)
})
...
test_that("Zbeta fails with an X supplied with too many numbers", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = c(700,900,1100)),
               "X should be a numeric vector of length 2 e.g. c(100,200)",
               fixed=TRUE)
})
...
test_that("Zbeta fails when ws is non-numeric", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = "3000bp", minRandL = 4, minRL = 25, X = NULL),
...
test_that("Zbeta fails when ws is zero", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 0, minRandL = 4, minRL = 25, X = NULL),
               "ws must be a number greater than 0")
})
...
test_that("Zbeta fails when pos is non-numeric", {
  ...
  expect_error(Zbeta(pos = paste0(df$POS,"bp"), x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = NULL),
...
test_that("Zbeta fails when minLandR is non-numeric", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = "4snps", minRL = 25, X = NULL),
...
test_that("Zbeta fails when minLandR is negative", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = -1, minRL = 25, X = NULL),
               "minRandL must be a number greater than or equal to 0")
})
...
test_that("Zbeta fails when minLR is non-numeric", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = "25b", X = NULL),
...
test_that("Zbeta fails when minLR is negative", {
  ...
  expect_error(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = -25, X = NULL),
               "minRL must be a number greater than or equal to 0")
})
...
test_that("Zbeta fails when x is not a matrix", {
  ...
  expect_error(Zbeta(pos = df$POS, x = df[,3:7], ws  = 3000, minRandL = 4, minRL = 25, X = NULL),
               "x must be a matrix")
})
...
test_that("Zbeta fails when the number of rows in x is not equal to the length of pos", {
  ...
  expect_error(Zbeta(pos = df$POS, x = t(as.matrix(df[,3:7])), ws  = 3000, minRandL = 4, minRL = 25, X = NULL),
...
test_that("Zbeta fails when a SNP has only one allele", {
  ...
  df1<-df
  df1[1,3:7]<-1
  expect_error(Zbeta(pos = df1$POS, x = as.matrix(df1[,3:7]), ws  = 3000, minRandL = 4, minRL = 25, X = NULL),
...
test_that("Zbeta warns about all NAs", {
  ...
  expect_warning(Zbeta(pos = df$POS, x = as.matrix(df[,3:7]), ws  = 3000, minRandL = 4, minRL = 50, X = NULL),
